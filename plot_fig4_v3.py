...
def plot_fig4():
    ...
    genotype_pars['hpv16']['transform_prob'] = 0.00008
    genotype_pars['hpv18']['transform_prob'] = 0.00005
    genotype_pars['hrhpv']['transform_prob'] = 0.00005
    ...
    pl.figtext(0.51, 0.955, 'B', fontweight='bold', fontsize=fs)
    pl.figtext(0.02, 0.47, 'C', fontweight='bold', fontsize=fs)
    pl.figtext(0.51, 0.47, 'D', fontweight='bold', fontsize=fs)
    fig.tight_layout()
    pl.savefig(f"{ut.figfolder}/fig4_v3.png", dpi=100)
